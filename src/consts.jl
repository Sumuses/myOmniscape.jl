...
const SUPPORTED_ARGS = ["resistance_file", "resistance_is_conductance",
    ...
    "n_conditions", "compare_to_future", "condition1_file", "condition2_file", "condition3_file","condition4_file",
    "condition1_future_file", "condition2_future_file", "condition3_future_file","condition4_future_file","comparison1",
    "comparison2","comparison3","comparison4", "condition1_lower", "condition2_lower","condition3_lower","condition4_lower", "condition1_upper",
    "condition2_upper", "condition3_upper","condition4_upper","reclassify_resistance", "reclass_table",
