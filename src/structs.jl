...
struct Conditions
    ...
    condition3_lower::Number
    condition3_upper::Number
    condition4_lower::Number
    condition4_upper::Number
end
...
struct ConditionLayers{T, N}
    ...
    condition3_present::MissingArray{T, N}
    condition3_future::MissingArray{T, N}
    condition4_present::MissingArray{T, N}
    condition4_future::MissingArray{T, N}
end
