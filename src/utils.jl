...
function source_target_match!(
    ...
    condition3_present = condition_layers.condition3_present
    condition3_future = condition_layers.condition3_future
    condition4_present = condition_layers.condition4_present
    condition4_future = condition_layers.condition4_future

    comparison1 = conditions.comparison1
    comparison2 = conditions.comparison2
    comparison3 = conditions.comparison3
    comparison4 = conditions.comparison4
    ...
    condition3_lower = conditions.condition3_lower
    condition3_upper = conditions.condition3_upper
    condition4_lower = conditions.condition4_lower
    condition4_upper = conditions.condition4_upper
    ...
    if n_conditions == 4
      ...
      con3_present_subset = condition3_present[ylower_buffered:yupper_buffered,
                                               xlower_buffered:xupper_buffered]
      if comparison3 == "within"
          value3 = median(skipmissing(condition3_future[ylower:yupper, xlower:xupper]))
          source_subset[coalesce.(((con3_present_subset .- value3) .> condition3_upper) .|
              ((con3_present_subset .- value2) .< condition3_lower), false)] .= 0
      elseif comparison3 == "equals"
          value3 = mode(skipmissing(condition3_future[ylower:yupper, xlower:xupper]))
          source_subset[coalesce.(con3_present_subset .!= value3, false)] .= 0
      end

      con4_present_subset = condition4_present[ylower_buffered:yupper_buffered,
                                               xlower_buffered:xupper_buffered]
      if comparison4 == "within"
          value4 = median(skipmissing(condition4_future[ylower:yupper, xlower:xupper]))
          source_subset[coalesce.(((con4_present_subset .- value4) .> condition4_upper) .|
              ((con4_present_subset .- value4) .< condition4_lower), false)] .= 0
      elseif comparison3 == "equals"
          value4 = mode(skipmissing(condition4_future[ylower:yupper, xlower:xupper]))
          source_subset[coalesce.(con4_present_subset .!= value4, false)] .= 0
      end
    end
end
