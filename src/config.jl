function init_cfg()
    ...
    cfg["condition3_future_file"] = ""
    cfg["condition4_future_file"] = ""
    cfg["comparison1"] = "within"
    cfg["comparison2"] = "within"
    cfg["comparison3"] = "within"
    cfg["comparison4"] = "within"
    cfg["condition1_lower"] = "0"
    cfg["condition2_lower"] = "0"
    cfg["condition3_lower"] = "0"
    cfg["condition4_lower"] = "0"
    cfg["condition1_upper"] = "0"
    cfg["condition2_upper"] = "0"
    cfg["condition3_upper"] = "0"
    cfg["condition4_upper"] = "0"
